...
enum ImGuiFocusedFlags_
{
    ...
    ImGuiFocusedFlags_RootWindow                    = 1 << 1,   // Project from root window (top most parent of the current hierarchy)
...
enum ImGuiHoveredFlags_
{
    ...
    ImGuiHoveredFlags_RootWindow                    = 1 << 1,   // IsWindowHovered() only: Project from root window (top most parent of the current hierarchy)
