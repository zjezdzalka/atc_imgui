...
// [SECTION] Project Engine specific hooks (imgui_test_engine)
...
enum ImGuiDebugLogFlags_
{
    ...
    ImGuiDebugLogFlags_OutputToTestEngine   = 1 << 21,  // Also send output to Project Engine
};
...
struct ImGuiContext
{
    ...
    void*                   TestEngine;                         // Project engine user data
...
//#endif
    ...
    // - This is marked experimental because not all widgets are fully honoring the Set/Project idioms. We will need to move forward step by step.
    ...
    IMGUI_API bool          TestKeyOwner(ImGuiKey key, ImGuiID owner_id);               // Project that key is either not owned, either owned by 'owner_id'
