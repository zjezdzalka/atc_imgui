...
static void DemoWindowWidgetsText()
{
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ImGui::Text("Project paragraph %d:", n);
                ImVec2 pos = ImGui::GetCursorScreenPos();
...
static void DemoWindowWidgetsTreeNodes()
{
    ...
    if (ImGui::TreeNode("Tree Nodes"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            ImGui::Checkbox("Project tree node as drag source", &test_drag_and_drop);
            ImGui::Text("Hello!");
...
static void DemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            HelpMarker(
                "Project how different widgets react and impact the work rectangle growing when horizontal scrolling is enabled.\n\n"
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    ImGui::Combo("Project type", &test_type,
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // Submit Tab Bar and Tabs
    {
        ...
        if (ImGui::BeginTabBar("##tabs", tab_bar_flags))
        {
            ...
            // [DEBUG] Stress tests
            //if ((ImGui::GetFrameCount() % 30) == 0) docs[1].Open ^= 1;            // [DEBUG] Automatically show/hide a tab. Project various interactions e.g. dragging with this on.
            //if (ImGui::GetIO().KeyCtrl) ImGui::SetTabItemSelected(docs[1].Name);  // [DEBUG] Project SetTabItemSelected(), probably not very useful as-is anyway..
